...
public class ListHospede {
    ...
    public void set(Hospede dado, int posicao) {
        if (posicao < 0 || posicao >= total || isEmpty()) {
            throw new RuntimeException("==>Posicao Invalida ou Lista Vazia");
        }
    ...
    public Hospede get(int posicao) {
        if (posicao < 0 || posicao >= total || isEmpty()) {
            throw new RuntimeException("==>Posicao Invalida ou Lista Vazia");
        }
    ...
    //método que me retorna o indice do hospede baseado em seu cpf
    public int existHospede(String cpf) {
        if (isEmpty()) {
